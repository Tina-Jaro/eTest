    ...
    return (
        ...
        relative transform transition-transform duration-500 ease-in-out'>
            <div style={{
                ...
                <div className='absolute top-[25%] text-[30px] left-[2%] text-center font-bold flex justify-center items-center text-white'>
                ...
                <div className='flex flex-col m-0 justify-center items-center top-[50%] pt-[25%] cursor-pointer '>
                 ...
                 hover:text-white text-[#CB2310] mt-[210px] md:mt-0
                 w-[100px] md:w-[180px] h-[30px] 3xl:w-[45%] 3xl:h-[70px] md:h-[50px] rounded-md 
                 text-[12px] md:text-[16px] 3xl:text-[28px] 4xl:text-[32px] font-[700]'>Get Started</button>
                </div>
